        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LotSizeAcres = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_OrganizationId_CustomerId_StreetAddress",
                table: "Properties",
                columns: new[] { "OrganizationId", "CustomerId", "StreetAddress" });
        }
